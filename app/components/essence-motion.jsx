  ...
  useEffect(() => {
    ...
    const context = gsap.context(() => {
      ...
      mm.add(
        ...
        () => {
          const strength = gsap.utils.toArray("[data-strength]");
          const chapters = gsap.utils.toArray("[data-evolution-step]");
          ...
          gsap.utils.toArray(".case-flow").forEach((flow) => {
            gsap.fromTo(
          ...
          gsap.utils
            .toArray(".ambition-project,.glc-ensemble>a")
            .forEach((el) => {
