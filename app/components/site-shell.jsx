...
import { ArrowUpRight, ArrowUp, Menu, X, ChevronDown } from "./icons";
const nav = [
  ["Solutions", "/solutions"],
  ["Work", "/work"],
  ["Our story", "/about"],
...
export function Header() {
  ...
  useEffect(() => {
    const close = (e) => {
      if (details.current && !details.current.contains(e.target))
...
export function Motion() {
  ...
  useEffect(() => {
    ...
    const context = gsap.context(() => {
      ...
      const sectionLinks = gsap.utils.toArray('.page-tabs a[href^="#"]');
      const setCurrentSection = (active) =>
      ...
      mm.add("(prefers-reduced-motion: no-preference)", () => {
        ...
        gsap.utils.toArray("[data-diagram]").forEach((el) => {
        ...
        gsap.utils
          .toArray("[data-manifesto]>span,[data-manifesto]>em")
          .forEach((el) =>
            gsap.fromTo(
              el,
              { opacity: 0.7, y: 12 },
      ...
      mm.add("(min-width: 768px)", () => {
        ...
        const bars = gsap.utils.toArray("[data-story-progress] i");
