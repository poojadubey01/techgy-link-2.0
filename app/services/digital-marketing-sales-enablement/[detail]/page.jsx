...
import { CTA, SectionTitle, Arrow } from "../../../components/connected";
import { MarketingFocus } from "../../../components/marketing-focus";
...
export default async function MarketingDetail({ params }) {
  const { detail } = await params;
  const m = marketing.find((m) => m.slug === detail);
  if (!m) notFound();
  return (
