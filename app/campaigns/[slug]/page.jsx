import { PartnerSignature } from "../../components/service-contribution";
import { notFound } from "next/navigation";
import { campaigns } from "@/data/catalogue";
import { ServiceVisual, SectionTitle, Arrow } from "../../components/connected";
  ...
  return (
    <main id="main">
      ...
      <section className="section wash">
        <div className="wrap">
          <SectionTitle label="A focused engagement" title={s.problem} />
      ...
      <section className="section campaign-form-section" id="start">
        <div className="wrap campaign-form-layout">
          <div>
            ...
            <p>
              {engagements[s.id].start} {engagements[s.id].output}
            </p>
          </div>
          <ContactForm
